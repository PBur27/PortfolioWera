  ...
  pl: {
    ...
    about: {
      ...
      section1: {
        ...
        text1: 'Projektuję i fotografuję, poruszając się między różnymi stylami i formami wyrazu. Lubię eksperymentować, mieszać techniki i odkrywać nowe rozwiązania - zarówno w sztuce, jak i w codziennym procesie twórczym.',
        text2: 'Moim punktem wyjścia był rysunek i malarstwo, do którego często wracam, budując kompozycję i narrację obrazu. Jestem absolwentką Liceum Plastycznego w Kielcach, aktualnie kończę studia licencjackie z komunikacji wizualnej na UKEN w Krakowie.',
        text3: 'Od kilku lat pracuję jako trenerka grafiki komputerowej, ucząc dzieci i młodzież w Gigantach Programowania i pomagając im stawiać pierwsze kroki w świecie projektowania. Pracuję także jako fotoreporterka na obozach młodzieżowych oraz wykonuję fotorelacje i dokumentacje wystaw na uczelni.',
      },
      section2: {
        header: 'Osiągnięcia',
        ex_individual: 'Wystawy indywidualne',
        list1_1: 'Ewolucja natury, Miejska Biblioteka Publiczna w Starachowicach, 2025',
        ...
        ex_other: 'Inne',
        list3_1: 'Wygrana konkursu na okładkę 27. dni Muzyki, Filharmonia Świętokrzyska w Kielcach, 2019',
        list3_2: 'Nominacja w kategorii Etykieta - debiuty, Art of Packaging, 2025',
  ...
  en: {
    ...
    about: {
      ...
      section1: {
        ...
        text1: 'A designer and photographer who navigates between different styles and forms of expression. I enjoy experimenting, mixing techniques, and exploring new solutions - both in art and in the everyday creative process.',
        text2: 'My starting point was drawing and painting, which I often return to when building the composition and narrative of an image. I am a graduate of the Fine Arts High School in Kielce, currently finishing my bachelor’s degree in visual communication at UKEN in Krakow.',
      ...
      section2: {
        ...
        list1_1: 'Ewolucja natury, Municipal Public Library in Starachowice, 2025',
        ...
        ex_other: 'Other',
        list3_1: 'Winner of the cover competition for the 27th Music Days, Świętokrzyska Philharmonic in Kielce, 2019',
        list3_2: 'Nomination in the Label - Debuts category, Art of Packaging, 2025',
