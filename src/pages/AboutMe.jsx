...
function AboutMe() {
  ...
  section1: {
    ...
    text1: language === "pl" 
      ? "Jestem Weronika Jabłońska, projektuję i fotografuję, poruszając się między różnymi stylami i formami wyrazu. Lubię eksperymentować, mieszać techniki i odkrywać nowe rozwiązania - zarówno w sztuce, jak i w codziennym procesie twórczym."
      : "I'm Weronika Jabłońska, a designer and photographer who navigates between different styles and forms of expression. I enjoy experimenting, mixing techniques, and exploring new solutions - both in art and in the everyday creative process.",
    text2: language === "pl"
  ...
  return (
    <div className="content">
      ...
      <div className="content-row">
        ...
        <AboutMeImage size="large" image1={image3} image2={image4}/>
      </div>
    </div>
  );
}
